...
insert into user (id, email_address, password, todoshare_account_id, active) values (1, 'oleksiy.rezchykov@gmail.com', '1234567890', 1, 1);
insert into user (id, email_address, password, todoshare_account_id, active) values (2, 'alex.mcgray@gmail.com', '1234567890', 2, 1);
